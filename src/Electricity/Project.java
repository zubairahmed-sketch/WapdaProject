...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        JMenuItem m4 = new JMenuItem("Add Units");
        ...
        m5.setMnemonic('X');
        m5.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.CTRL_MASK));
        ...
        JMenuItem u1 = new JMenuItem("E-Bill");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        }else if(msg.equals("Add Units")){
            new CalculateBill().setVisible(true);
            
        }else if(msg.equals("E-Bill")){
